...
public class RadarFactory {
     ...
     * @return 配置好的电磁波雷达实例
     */
    public static ElectromagneticRadar createRadar(String deviceId, String deviceName,
        ...
        DeviceInitParamsDTO initParams = new DeviceInitParamsDTO(
                ...
                detectionRange, radarParams.getScanPattern().getFov(),
                radarParams
        );
    ...
    public static List<ElectromagneticRadar> createRadarNetwork(String namePrefix, Position centerPosition,
        ...
        for (int i = 0; i < gridSize; i++) {
            for (int j = 0; j < gridSize; j++) {
                ...
                ElectromagneticRadar radar = createRadar(
