...
public class Airspace {
    ...
    public Airspace(String name, double minX, double minY, double minZ, double maxX, double maxY, double maxZ) {
        ...
        // 初始化组件
        this.environmentParameters = EnvironmentParameters.of(EnvironmentParameters.WeatherType.DAY_CLEAR);
     ...
     * 更新环境参数
     *
     * @param weatherType 新的天气类型
     */
    public void updateEnvironmentParameters(EnvironmentParameters.WeatherType weatherType) {
        this.environmentParameters = EnvironmentParameters.of(weatherType);
        updateLastModifiedTime();
    }
     ...
     * @return 设备列表
     */
    public List<AbstractProbeDevice> getProbeDevicesByType(DeviceType deviceType) {
     ...
     * @return 活跃设备列表
     */
    public List<AbstractProbeDevice> getActiveProbeDevices() {
        return probeDevices.values().stream()
